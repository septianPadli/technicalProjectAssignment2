...
// console.log(semuaTagP[2])

// const semuaTextCenter = document.getElementsByClassName('text-center')
// console.log(semuaTextCenter)

// const namaMentee1 = document.querySelector('li')
// console.log(namaMentee1)

// const semuaMentee = document.querySelectorAll('.nama')
// console.log(semuaMentee)

// const halo = document.getElementsByClassName('halo')
// console.log(halo[0].innerHTML)

// halo[0].innerHTML = 'hello there'
// halo[0].innerHTML = '<h1>hello there</h1>'


// 1. select element html
// 2. kita perlu looping data nya: for, for each, while loop
// 3. di tiap loopingan kita mau update html nya dengan data item nya

// const shoppingItems = ['apple', 'ayam', 'sayur', 'cemilan']
// const listBelanja = document.querySelector('#listBelanja')

// shoppingItems.forEach(item => listBelanja.innerHTML += `<li>${item}</li>`)
...
function filterVote() {
  let vote = document.getElementById('voteAve').value
  
  for (let index = 0; index < movies.length; index++) {
    let voteAve = document.getElementsByClassName('voteAve')[index].value
    
    if (voteAve < vote) {
      document.getElementsByClassName('movie-container')[index].classList.add("d-none") 
    } else if(vote == 0) {
      document.getElementsByClassName('movie-container')[index].classList.remove("d-none") 
    }
...
function filterTitle() {
  let search = document.getElementById('titleSearch').value.toLowerCase()
  
  for (let index = 0; index < movies.length; index++) {
    let title = document.getElementsByClassName('title-search')[index].value.toLowerCase()
